    ...
    public void saveOnAction(ActionEvent event) throws IOException {
        ...
        if (optional.get() == ButtonType.OK) {
            ...
            if (CheckInput.isAllCorrectType(checkBoolean)) {
                ...
                EventLogsDBConnector.saveLog(DateUtilities.getDateNumber(),"(E) Error",AccountManager.getAccount().getUsername(),"Could not save post treatment","Create Post Treatment");
