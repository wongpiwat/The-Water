        ...
        monthChoiceBox.getSelectionModel().selectedItemProperty().addListener(new ChangeListener() {
            ...
            public void changed(ObservableValue monthObservable, Object monthOldValue, Object monthNewValue) {
                ...
                if (year != null && monthNewValue != null) {
                    ...
                    report.add(new Report("1",oneWeekTreatments.size(),CalculateUtilities.getAverageVolumeWater(oneWeekTreatments),CalculateUtilities.getAverageTemperature(oneWeekTreatments),CalculateUtilities.getAveragePH(oneWeekTreatments),CalculateUtilities.getAverageDissolvedOxygen(oneWeekTreatments),CalculateUtilities.getAverageVolumeSediment(oneWeekTreatments),CalculateUtilities.getAverageMLSS(oneWeekTreatments),CalculateUtilities.getAverageElectricity(oneWeekTreatments),CalculateUtilities.getAverageDeodorizerSystem(oneWeekTreatments),CalculateUtilities.getCountStandard(oneWeekTreatments)));
                    report.add(new Report("2",twoWeekTreatments.size(),CalculateUtilities.getAverageVolumeWater(twoWeekTreatments),CalculateUtilities.getAverageTemperature(twoWeekTreatments),CalculateUtilities.getAveragePH(twoWeekTreatments),CalculateUtilities.getAverageDissolvedOxygen(twoWeekTreatments),CalculateUtilities.getAverageVolumeSediment(twoWeekTreatments),CalculateUtilities.getAverageMLSS(twoWeekTreatments),CalculateUtilities.getAverageElectricity(twoWeekTreatments),CalculateUtilities.getAverageDeodorizerSystem(twoWeekTreatments),CalculateUtilities.getCountStandard(twoWeekTreatments)));
                    report.add(new Report("3",threeWeekTreatments.size(),CalculateUtilities.getAverageVolumeWater(threeWeekTreatments),CalculateUtilities.getAverageTemperature(threeWeekTreatments),CalculateUtilities.getAveragePH(threeWeekTreatments),CalculateUtilities.getAverageDissolvedOxygen(threeWeekTreatments),CalculateUtilities.getAverageVolumeSediment(threeWeekTreatments),CalculateUtilities.getAverageMLSS(threeWeekTreatments),CalculateUtilities.getAverageElectricity(threeWeekTreatments),CalculateUtilities.getAverageDeodorizerSystem(threeWeekTreatments),CalculateUtilities.getCountStandard(threeWeekTreatments)));
                    report.add(new Report("4",fourWeekTreatments.size(),CalculateUtilities.getAverageVolumeWater(fourWeekTreatments),CalculateUtilities.getAverageTemperature(fourWeekTreatments),CalculateUtilities.getAveragePH(fourWeekTreatments),CalculateUtilities.getAverageDissolvedOxygen(fourWeekTreatments),CalculateUtilities.getAverageVolumeSediment(fourWeekTreatments),CalculateUtilities.getAverageMLSS(fourWeekTreatments),CalculateUtilities.getAverageElectricity(fourWeekTreatments),CalculateUtilities.getAverageDeodorizerSystem(fourWeekTreatments),CalculateUtilities.getCountStandard(fourWeekTreatments)));
                    ...
                    report.add(new Report(" ",allTreatments.size(),CalculateUtilities.getAverageVolumeWater(allTreatments),CalculateUtilities.getAverageTemperature(allTreatments),CalculateUtilities.getAveragePH(allTreatments),CalculateUtilities.getAverageDissolvedOxygen(allTreatments),CalculateUtilities.getAverageVolumeSediment(allTreatments),CalculateUtilities.getAverageMLSS(allTreatments),CalculateUtilities.getAverageElectricity(allTreatments),CalculateUtilities.getAverageDeodorizerSystem(allTreatments),CalculateUtilities.getCountStandard(allTreatments)));
