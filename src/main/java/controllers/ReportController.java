        ...
        monthChoiceBox.getSelectionModel().selectedItemProperty().addListener(new ChangeListener() {
            ...
            public void changed(ObservableValue monthObservable, Object monthOldValue, Object monthNewValue) {
                ...
                if (year != null && monthNewValue != null) {
                    ...
                    report.add(new Report("Total:",allTreatments.size(),CalculateUtilities.getAverageVolumeWater(allTreatments),CalculateUtilities.getAverageTemperature(allTreatments),CalculateUtilities.getAveragePH(allTreatments),CalculateUtilities.getAverageDissolvedOxygen(allTreatments),CalculateUtilities.getAverageVolumeSediment(allTreatments),CalculateUtilities.getAverageMLSS(allTreatments),CalculateUtilities.getAverageElectricity(allTreatments),CalculateUtilities.getAverageDeodorizerSystem(allTreatments),CalculateUtilities.getCountStandard(allTreatments)));
